...
const WORDS_PATH: String = "res://src/gameplay/families/flash_words/content/words_v1.json"
const TEMPLATES_PATH: String = "res://src/gameplay/families/flash_words/content/templates_v1.json"
...
var _tutorial_profile := TutorialProfile.new({
	...
	"tutorial_version": "1",
	"scene_path": "res://src/gameplay/families/flash_words/tutorial/FlashWordsTutorial.tscn",
