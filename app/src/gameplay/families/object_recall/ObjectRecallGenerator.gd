...
const RENDERER_SCRIPT := "res://src/gameplay/families/object_recall/ObjectRecallView.gd"
const OBJECTS_PATH := "res://src/gameplay/families/object_recall/content/objects_v2.json"
