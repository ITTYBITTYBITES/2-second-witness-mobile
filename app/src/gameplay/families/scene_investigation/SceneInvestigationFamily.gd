...
const CONTENT_PATHS := [
	"res://src/gameplay/families/scene_investigation/content/office_v1.json",
	"res://src/gameplay/families/scene_investigation/content/kitchen_v1.json",
	"res://src/gameplay/families/scene_investigation/content/workshop_v1.json",
	"res://src/gameplay/families/scene_investigation/content/travel_desk_v1.json",
	"res://src/gameplay/families/scene_investigation/content/garden_bench_v1.json"
]
...
var _tutorial_profile := TutorialProfile.new({
	...
	"tutorial_version": "2",
	"scene_path": "res://src/gameplay/families/scene_investigation/tutorial/SceneInvestigationTutorial.tscn",
