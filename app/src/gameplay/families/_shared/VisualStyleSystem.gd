...
const MASTER_MANIFEST: Dictionary = {
	...
	"banana":         {"sprite": "banana.png",         "available": false},
	"basket":         {"sprite": "basket.png",         "available": false},
	...
	"bread":          {"sprite": "bread.png",          "available": false},
	"brush":          {"sprite": "brush.png",          "available": true},
	"calculator":     {"sprite": "calculator.png",     "available": false},
	"camera":         {"sprite": "camera.png",         "available": true},
	"clamp":          {"sprite": "clamp.png",          "available": false},
	...
	"drill":          {"sprite": "drill.png",          "available": false},
	...
	"hammer":         {"sprite": "hammer.png",         "available": false},
	"hardware":       {"sprite": "hardware.png",       "available": true},
	"jar":            {"sprite": "jar.png",            "available": true},
	"kettle":         {"sprite": "kettle.png",         "available": false},
	"keys":           {"sprite": "keys.png",           "available": true},
	"lamp":           {"sprite": "lamp.png",           "available": false},
	"level":          {"sprite": "level.png",          "available": false},
	"magnifier":      {"sprite": "magnifier.png",      "available": false},
	"marker":         {"sprite": "marker.png",         "available": true},
	"mask":           {"sprite": "mask.png",           "available": false},
	"measuring_cup":  {"sprite": "measuring_cup.png",  "available": true},
	"mouse":          {"sprite": "mouse.png",          "available": false},
	...
	"pot":            {"sprite": "pot.png",            "available": false},
	...
	"tag":            {"sprite": "tag.png",            "available": false},
	"tape":           {"sprite": "tape.png",           "available": true},
	"tape_measure":   {"sprite": "tape_measure.png",   "available": true},
	"toaster":        {"sprite": "toaster.png",        "available": false},
	"toolbox":        {"sprite": "toolbox.png",        "available": true},
	"towel":          {"sprite": "towel.png",          "available": true},
	"trowel":         {"sprite": "trowel.png",         "available": false},
	"watering_can":   {"sprite": "watering_can.png",   "available": false},
	"whisk":          {"sprite": "whisk.png",          "available": false},
	"wrench":         {"sprite": "wrench.png",         "available": false},
