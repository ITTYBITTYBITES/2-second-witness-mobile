...
@export var is_loading: bool = false : set = set_loading
...
func _apply_theme() -> void:
	...
	match variant:
		...
		Variant.GHOST:
			...
			style_hover = style_normal.duplicate()
			style_hover.bg_color = Color(tokens.get("surface_elevated", Color.GRAY), 0.5)
	...
	style_disabled.bg_color = Color(style_normal.bg_color, 0.4)
