...
*   `scenes/ui/screens/LandingScreen.tscn (BtnDiscover)`
*   `scenes/scenarios/ReflexTap.tscn (TargetBtn)`
...
*   `scenes/scenarios/MCT0_Calibration.tscn (TargetBtn)`
*   `scenes/ui/screens/WeeklyFeaturedScreen.tscn (BtnReturn)`
*   `scenes/scenarios/SpatialRecall.tscn (B7)`
*   `scenes/scenarios/StroopTest.tscn (Btn2)`
